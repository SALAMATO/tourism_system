# Generated by Django 6.0.2 on 2026-05-18 07:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='destination/', verbose_name='封面图片')),
                ('gallery_image_1', models.ImageField(blank=True, null=True, upload_to='destination/', verbose_name='展示图片1')),
                ('gallery_image_2', models.ImageField(blank=True, null=True, upload_to='destination/', verbose_name='展示图片2')),
                ('gallery_image_3', models.ImageField(blank=True, null=True, upload_to='destination/', verbose_name='展示图片3')),
                ('gallery_image_4', models.ImageField(blank=True, null=True, upload_to='destination/', verbose_name='展示图片4')),
                ...
                ('publish_date', models.DateTimeField(blank=True, help_text='用于最新发布排序，留空则使用创建时间', null=True, verbose_name='发布日期')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='news/', verbose_name='封面图片')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('normalized_question', models.TextField(blank=True, help_text='用于提高语义匹配命中率', null=True, verbose_name='标准化后的问题')),
            ...
            options={
                ...
                'db_table': 'ai_cache',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['query_type', 'is_valid'], name='ai_cache_query_t_7ef4ed_idx'), models.Index(fields=['cache_key'], name='ai_cache_cache_k_a15c8b_idx'), models.Index(fields=['normalized_question'], name='ai_cache_normali_7ab57d_idx')],
            },
        ),
        migrations.CreateModel(
            name='AIConversation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='消息ID')),
                ('role', models.CharField(choices=[('user', '用户'), ('assistant', 'AI助手'), ('system', '系统')], max_length=20, verbose_name='角色')),
                ('content', models.TextField(verbose_name='消息内容')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('conversation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='api.aiconversation', verbose_name='所属会话')),
            ],
            options={
                'verbose_name': '聊天消息',
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['conversation', 'created_at'], name='ai_conversa_convers_40953b_idx'),
        ),
