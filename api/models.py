...
class Destination(models.Model):
    ...
    cover_image = models.ImageField(upload_to='destination/', blank=True, null=True, verbose_name='封面图片')
    gallery_image_1 = models.ImageField(upload_to='destination/', blank=True, null=True, verbose_name='展示图片1')
    gallery_image_2 = models.ImageField(upload_to='destination/', blank=True, null=True, verbose_name='展示图片2')
    gallery_image_3 = models.ImageField(upload_to='destination/', blank=True, null=True, verbose_name='展示图片3')
    gallery_image_4 = models.ImageField(upload_to='destination/', blank=True, null=True, verbose_name='展示图片4')
